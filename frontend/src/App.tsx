...
export function App() {
  ...
  const [messages, setMessages] = useState<Message[]>([{ id: 0, sender: "assistant", text: "Hi, I’m Aivoa AI. Paste a complaint or attach a document and I’ll populate the form for you." }]);
